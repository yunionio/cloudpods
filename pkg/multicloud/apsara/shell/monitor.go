...
func init() {
	...
	shellutils.R(&NamespaceListOptions{}, "namespace-list", "List monbitor metric namespaces", func(cli *apsara.SRegion, args *NamespaceListOptions) error {
	...
	shellutils.R(&MetricListOptions{}, "metrics-list", "List metrics in a namespace", func(cli *apsara.SRegion, args *MetricListOptions) error {
	...
	shellutils.R(&DescribeMetricListOptions{}, "metric-data-list", "DescribeMetricList", func(cli *apsara.SRegion, args *DescribeMetricListOptions) error {
		var since time.Time
		var err error
		if len(args.Since) > 0 {
