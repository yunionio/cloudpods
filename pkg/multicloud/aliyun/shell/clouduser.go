...
func init() {
	...
	shellutils.R(&ClouduserCreateOptions{}, "cloud-user-create", "Create Cloud user", func(cli *aliyun.SRegion, args *ClouduserCreateOptions) error {
		user, err := cli.GetClient().CreateClouduser(args.NAME, args.MobilePhone, args.Email, args.Comments)
		if err != nil {
			return err
		}
		printObject(user)
	...
	shellutils.R(&ClouduserListOptions{}, "cloud-user-list", "List Cloud users", func(cli *aliyun.SRegion, args *ClouduserListOptions) error {
		users, _, err := cli.GetClient().GetCloudusers(args.Marker, args.MaxItems)
		if err != nil {
			return err
		}
	...
	shellutils.R(&ClouduserOptions{}, "cloud-user-delete-loginprofile", "Delete Cloud user loginprofile", func(cli *aliyun.SRegion, args *ClouduserOptions) error {
	...
	shellutils.R(&LoginProfileCreateOptions{}, "cloud-user-create-loginprofile", "Create Cloud user loginprofile", func(cli *aliyun.SRegion, args *LoginProfileCreateOptions) error {
	...
	shellutils.R(&LoginProfileCreateOptions{}, "cloud-user-reset-password", "Reset Cloud user password", func(cli *aliyun.SRegion, args *LoginProfileCreateOptions) error {
