/*
 * @Author: your name
 * @Date: 2022-02-16 21:32:49
 * @LastEditTime: 2022-02-16 21:48:10
...
func (self *SRegion) GetStorages() ([]SStorage, error) {
	...
	for i := range storages {
		if storages[i].Name == "BingoManagementShare" { // https://portal.nutanix.com/page/documents/details?targetId=Web-Console-Guide-Prism-v5_15-ZH:wc-container-create-wc-t.html
			continue
		}
