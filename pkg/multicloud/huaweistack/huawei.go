...
import (
	...
	"yunion.io/x/onecloud/pkg/multicloud/huaweistack/client"
...
const (
	CLOUD_PROVIDER_HUAWEI    = api.CLOUD_PROVIDER_HUAWEI_CLOUD_STACK
	CLOUD_PROVIDER_HUAWEI_CN = "华为云Stack"
	CLOUD_PROVIDER_HUAWEI_EN = "HuaweiCloudStack"
...
func NewHuaweiClientConfig(accessKey, accessSecret, projectId string, endpoints *cloudprovider.SHuaweiCloudStackEndpoints) *HuaweiClientConfig {
