...
func (o baseOptions) UUID(uuid string) string {
	return "-uuid " + uuid
}
...
func (o baseOptions) VdiSpice(spicePort uint, pciBus string) []string {
	return []string{
		...
		// usb redirect
		o.Device("ich9-usb-ehci1,id=usb"),
		o.Device("ich9-usb-uhci1,masterbus=usb.0,firstport=0,multifunction=on"),
		o.Device("ich9-usb-uhci2,masterbus=usb.0,firstport=2"),
		o.Device("ich9-usb-uhci3,masterbus=usb.0,firstport=4"),
...
func (o baseOptions_aarch64) SMP(cpus uint) string {
	...
	return fmt.Sprintf("-smp cpus=%d,maxcpus=32", cpus)
}
