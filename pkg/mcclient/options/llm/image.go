...
type LLMImageListOptions struct {
	...
	LLMType string `json:"llm_type" choices:"ollama|dify|vllm" help:"filter by llm type"`
}
...
type LLMImageCreateOptions struct {
	...
	LLM_TYPE     string `json:"llm_type" choices:"ollama|dify|vllm" help:"llm type: ollama、vllm or dify"`
}
...
type LLMImageUpdateOptions struct {
	...
	CredentialId string `json:"credential_id"`
	LlmType      string `json:"llm_type" choices:"ollama|dify|vllm" help:"llm type: ollama or dify"`
}
