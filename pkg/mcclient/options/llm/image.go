...
type LLMImageListOptions struct {
	...
	LLMType string `json:"llm_type" choices:"ollama|dify|comfyui|vllm|sglang|hermes-agent" help:"filter by llm type"`
}
...
type LLMImageCreateOptions struct {
	...
	LLM_TYPE     string `json:"llm_type" choices:"ollama|dify|comfyui|vllm|sglang|hermes-agent" help:"llm type: ollama, comfyui, vllm, sglang, hermes-agent or dify"`
}
...
type LLMImageUpdateOptions struct {
	...
	CredentialId string `json:"credential_id"`
	LlmType      string `json:"llm_type" choices:"ollama|dify|vllm|sglang|comfyui|hermes-agent" help:"llm type: ollama, comfyui, vllm, sglang, hermes-agent or dify"`
}
