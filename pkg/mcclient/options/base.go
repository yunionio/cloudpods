...
type BaseListOptions struct {
	...
	Provider     []string `help:"List objects from the provider；公有云/私有云创建时必传，例如 Aliyun、Aws、Huawei、CAS" choices:"OneCloud|VMware|Aliyun|Apsara|Qcloud|Azure|Aws|Huawei|OpenStack|Ucloud|RockBase|VolcEngine|ZStack|Google|Ctyun|Cloudpods|Nutanix|BingoCloud|IncloudSphere|JDcloud|Proxmox|Ceph|CephFS|Ecloud|HCSO|HCS|HCSOP|H3C|S3|RemoteFile|Ksyun|Baidu|QingCloud|OracleCloud|SangFor|ZettaKit|UIS|CAS|CNWare" json:"provider,omitempty" mcp:"true"`
