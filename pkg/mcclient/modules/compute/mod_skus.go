...
func init() {
	...
	ServerSkus = ServerSkusManager{modules.NewComputeManager("serversku", "serverskus",
	...
	ElasticcacheSkus = ElasticcacheSkusManager{modules.NewComputeManager("elasticcachesku", "elasticcacheskus",
		[]string{},
		[]string{})}
