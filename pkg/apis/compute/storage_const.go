...
const (
	...
	STORAGE_ZSTACK_ROOT          = "root"
	STORAGE_ZSTACK_DATA          = "data"
	STORAGE_ZSTACK_IMAGECACHE    = "imagecache"
)
...
var (
	...
	STORAGE_TYPES = []string{STORAGE_LOCAL, STORAGE_BAREMETAL, STORAGE_SHEEPDOG,
		...
		STORAGE_ZSTACK_LOCAL_STORAGE, STORAGE_ZSTACK_ROOT, STORAGE_ZSTACK_DATA, STORAGE_ZSTACK_IMAGECACHE,
	}
