...
type SDisk struct {
	...
	// Column(Integer, nullable=False) # in MB
...
type SHost struct {
	...
	// Column(TINYINT, nullable=True) # cpu count
	NodeCount byte `json:"node_count"`
	// Column(TINYINT, nullable=True)
	CpuDesc string `json:"cpu_desc"`
	// Column(VARCHAR(64, charset='ascii'), nullable=True)
	CpuMhz int `json:"cpu_mhz"`
	// Column(Integer, nullable=True) # cpu MHz
	CpuCache int `json:"cpu_cache"`
	// Column(Integer, nullable=True) # cpu Cache in KB
	...
	// Column(Integer, nullable=True) # memory size in MB
	MemReserved int `json:"mem_reserved"`
	// Column(Integer, nullable=True, default=0) # memory reserved in MB
	MemCmtbound float32 `json:"mem_cmtbound"`
	StorageSize int     `json:"storage_size"`
	// Column(Integer, nullable=True) # storage size in MB
	StorageType string `json:"storage_type"`
	// Column(VARCHAR(20, charset='ascii'), nullable=True)
...
type SHostwire struct {
	...
	// Column(VARCHAR(16, charset='ascii'), nullable=False)
...
type SKeypair struct {
	...
	// Column(VARCHAR(length=12, charset='ascii'), nullable=True, default='RSA')
	Fingerprint string `json:"fingerprint"`
	// Column(VARCHAR(length=48, charset='ascii'), nullable=False)
	PrivateKey string `json:"private_key"`
	// Column(VARCHAR(length=2048, charset='ascii'), nullable=False)
	PublicKey string `json:"public_key"`
	// Column(VARCHAR(length=1024, charset='ascii'), nullable=False)
...
type SStorage struct {
	...
	// Column(Integer, nullable=False) # capacity of disk in MB
...
type SStoragecachedimage struct {
	...
	// = Column(VARCHAR(32, charset='ascii'), nullable=False,
	Path string `json:"path"`
	// = Column(VARCHAR(256, charset='utf8'), nullable=True)
...
type SWire struct {
	...
	apis.SExternalizedResourceBase
	Bandwidth int `json:"bandwidth"`
	// = Column(Integer, nullable=False) # bandwidth of network in Mbps
	Mtu          int `json:"mtu"`
...
type SZone struct {
	...
	apis.SExternalizedResourceBase
	Location string `json:"location"`
	// = Column(VARCHAR(256, charset='utf8'))
