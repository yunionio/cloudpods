...
type HostDetails struct {
	...
	// 实际已使用存储大小
	RealTimeStorageUsed int64 `json:"real_time_storage_used"`
	// 浪费存储大小(异常磁盘存储大小)
...
type HostRegisterMetadata struct {
	...
	RootPartitionTotalCapacity int64  `json:"root_partition_total_capacity"`
	RootPartitionUsedCapacity  int64  `json:"root_partition_used_capacity"`
}
