...
func (self *SScopedPolicy) GetExtraDetails(ctx context.Context, userCred mcclient.TokenCredential, query jsonutils.JSONObject, isList bool) (api.ScopedPolicyDetails, error) {
	return api.ScopedPolicyDetails{}, nil
}
