...
type SCloudpodsPodGuestDriver struct {
	SManagedVirtualizedGuestDriver
}

func init() {
	driver := SCloudpodsPodGuestDriver{}
	models.RegisterGuestDriver(&driver)
}

func (self *SCloudpodsPodGuestDriver) DoScheduleCPUFilter() bool { return true }

func (self *SCloudpodsPodGuestDriver) DoScheduleMemoryFilter() bool { return true }

func (self *SCloudpodsPodGuestDriver) DoScheduleSKUFilter() bool { return false }

func (self *SCloudpodsPodGuestDriver) DoScheduleStorageFilter() bool { return true }

func (self *SCloudpodsPodGuestDriver) GetHypervisor() string {
	return api.HYPERVISOR_POD
}

func (self *SCloudpodsPodGuestDriver) GetProvider() string {
	return api.CLOUD_PROVIDER_CLOUDPODS
}

func (self *SCloudpodsPodGuestDriver) GetGuestInitialStateAfterCreate() string {
	return api.VM_READY
}

func (self *SCloudpodsPodGuestDriver) DoGuestCreateDisksTask(ctx context.Context, guest *models.SGuest, task taskman.ITask) error {
...
func (self *SCloudpodsPodGuestDriver) GetDetachDiskStatus() ([]string, error) {
	return []string{api.VM_READY, api.VM_RUNNING}, nil
}

func (self *SCloudpodsPodGuestDriver) GetAttachDiskStatus() ([]string, error) {
	return []string{api.VM_READY, api.VM_RUNNING}, nil
}

func (self *SCloudpodsPodGuestDriver) GetRebuildRootStatus() ([]string, error) {
	return []string{api.VM_READY, api.VM_RUNNING}, nil
}

func (self *SCloudpodsPodGuestDriver) IsChangeInstanceTypeWhileRunningSupported(guest *models.SGuest) (bool, error) {
	return true, nil
}

func (self *SCloudpodsPodGuestDriver) GetDeployStatus() ([]string, error) {
	return []string{api.VM_READY, api.VM_ADMIN}, nil
}

func (self *SCloudpodsPodGuestDriver) IsSupportCdrom(guest *models.SGuest) (bool, error) {
	return true, nil
}

func (self *SCloudpodsPodGuestDriver) IsSupportFloppy(guest *models.SGuest) (bool, error) {
	return false, nil
}

func (self *SCloudpodsPodGuestDriver) IsSupportMigrate() bool {
	return true
}

func (self *SCloudpodsPodGuestDriver) IsSupportLiveMigrate() bool {
	return true
}

func (self *SCloudpodsPodGuestDriver) GetUserDataType() string {
	return cloudprovider.CLOUD_SHELL_WITHOUT_ENCRYPT
}

func (self *SCloudpodsPodGuestDriver) ValidateResizeDisk(guest *models.SGuest, disk *models.SDisk, storage *models.SStorage) error {
...
func (self *SCloudpodsPodGuestDriver) GetComputeQuotaKeys(scope rbacscope.TRbacScope, ownerId mcclient.IIdentityProvider, brand string) models.SComputeResourceKeys {
...
func (self *SCloudpodsPodGuestDriver) GetDefaultSysDiskBackend() string {
	return api.STORAGE_LOCAL
}

func (self *SCloudpodsPodGuestDriver) GetInstanceCapability() cloudprovider.SInstanceCapability {
...
func (self *SCloudpodsPodGuestDriver) GetMinimalSysDiskSizeGb() int {
	return options.Options.DefaultDiskSizeMB / 1024
}

func (self *SCloudpodsPodGuestDriver) ValidateCreateData(ctx context.Context, userCred mcclient.TokenCredential, input *api.ServerCreateInput) (*api.ServerCreateInput, error) {
