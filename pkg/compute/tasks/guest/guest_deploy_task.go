...
func (self *GuestDeployTask) OnGuestNetworkReady(ctx context.Context, guest *models.SGuest) {
	...
	bmImportFakeServer := jsonutils.QueryBoolean(self.Params, "fake_create_from_bm_import", false)
	if !bmImportFakeServer && jsonutils.QueryBoolean(self.Params, "restart", false) {
