...
func (self *DiskCreateTask) OnGuestSyncstatusComplete(ctx context.Context, guest *models.SDisk, data jsonutils.JSONObject) {
	self.SetStageComplete(ctx, nil)
}

func (self *DiskCreateTask) OnGuestSyncstatusCompleteFailed(ctx context.Context, guest *models.SDisk, err jsonutils.JSONObject) {
	// ??? why
