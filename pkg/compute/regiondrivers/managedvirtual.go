...
func (self *SManagedVirtualizationRegionDriver) RequestCreateSnapshotPolicy(ctx context.Context, userCred mcclient.TokenCredential, sp *models.SSnapshotPolicy, task taskman.ITask) error {
	...
	taskman.LocalTaskRun(task, func() (jsonutils.JSONObject, error) {
		...
		//		return nil, err
		//	}
		//	input := sp.GenerateCreateSpParams()
		//
...
func (self *SManagedVirtualizationRegionDriver) RequestUpdateSnapshotPolicy(ctx context.Context, userCred mcclient.
	...
	//if err != nil {
	//	return errors.Wrapf(err, "Fetch cache of snapshotpolicy.yaml %s", sp.GetId())
	//}
...
func (self *SManagedVirtualizationRegionDriver) RequestDeleteSnapshotPolicy(ctx context.Context, userCred mcclient.TokenCredential, sp *models.SSnapshotPolicy, task taskman.ITask) error {
	taskman.LocalTaskRun(task, func() (jsonutils.JSONObject, error) {
		err := models.SnapshotPolicyCacheManager.DeleteCloudSnapshotPolices(ctx, userCred, sp.GetId())
		if err != nil {
			return nil, err
		}
		return nil, nil
...
func (self *SManagedVirtualizationRegionDriver) RequestApplySnapshotPolicy(ctx context.Context, userCred mcclient.TokenCredential, task taskman.ITask, disk *models.SDisk, sp *models.SSnapshotPolicy, data jsonutils.JSONObject) error {
	...
	taskman.LocalTaskRun(task, func() (jsonutils.JSONObject, error) {
		...
		if err != nil {
			return nil, errors.Wrap(err, "register snapshotpolicy.yaml cache failed")
		}
