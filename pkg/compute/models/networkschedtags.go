...
func (manager *SNetworkschedtagManager) GetSubordinateFieldName() string {
	return "network_id"
}

func (s *SNetworkschedtag) GetNetwork() *SNetwork {
	return s.Main().(*SNetwork)
}
...
func (s *SNetworkschedtag) Main() db.IStandaloneModel {
	return s.SSchedtagJointsBase.main(s)
}
