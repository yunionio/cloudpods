...
func getSharedApiWorkerEnv() []*apis.ContainerKeyValue {
	if sharedApiWorkerEnvKeyVal == nil {
		sharedApiWorkerEnv := &DifyContainerEnv{
			...
			"CELERY_BROKER_URL":                                "redis://:difyai123456@127.0.0.1:6379/1",
			"CELERY_BACKEND":                                   "127.0.0.1",
			...
			"SANDBOX_HTTP_PROXY":                               "http://127.0.0.1:3128",
			"SANDBOX_HTTPS_PROXY":                              "http://127.0.0.1:3128",
			"SANDBOX_PORT":                                     "8194",
			...
			"PLUGIN_DIFY_INNER_API_URL":                        "http://127.0.0.1:5001",
