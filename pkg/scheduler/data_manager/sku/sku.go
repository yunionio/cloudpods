...
func (e eventHandler) deleteServerSku(instanceType string) error {
	e.dataMan.skuMap.Delete(instanceType)
	return nil
}
...
func (e eventHandler) updateServerSku(newObj *jsonutils.JSONDict) error {
	...
	if shouldDelete {
		...
		if err := e.deleteServerSku(sku.Name); err != nil {
...
func (cache *skuMap) Delete(instanceType string) {
	cache.Map.Delete(instanceType)
}
