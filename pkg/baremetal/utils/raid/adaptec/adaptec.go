...
/*
 * func (ada *AdaptecRaidAdaptor) FindRemoteMatchedDisk(input *raid.MatchedDiskParams, remoteDisks []*types.SDiskInfo) (*types.SDiskInfo, error) {
 * 	if input.RaidConfig == baremetal.DISK_CONF_NONE {
 * 		return remoteDisks[input.Index], nil
 * 	}
 * 	return nil, nil
 * }
 */
