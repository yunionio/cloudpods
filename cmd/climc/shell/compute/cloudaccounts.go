...
func init() {
	...
	cmd.PerformClass("prepare-nets", &options.SVMwareCloudAccountPrepareNetsOptions{})

	cmd.CreateWithKeyworkd("create-vmware", &options.SVMwareCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-aliyun", &options.SAliyunCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-azure", &options.SAzureCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-qcloud", &options.SQcloudCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-google", &options.SGoogleCloudAccountCreateOptions{})
	...
	cmd.CreateWithKeyworkd("create-xsky", &options.SXskyCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-ctyun", &options.SCtyunCloudAccountCreateOptions{})
	cmd.CreateWithKeyworkd("create-apsara", &options.SApsaraCloudAccountCreateOptions{})
