...
func New(c Config) *HarborAPI {
	...
	cli.ChartRepository = chart_repository.New(transport, strfmt.Default, c.AuthInfo)
	cli.Version = version.New(transport, strfmt.Default, c.AuthInfo)
	return cli
}

// HarborAPI is a client for harbor API
type HarborAPI struct {
	ChartRepository *chart_repository.Client
