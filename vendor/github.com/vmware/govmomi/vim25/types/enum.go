...
const (
	...
	ClusterDasFdmAvailabilityStateMain                       = ClusterDasFdmAvailabilityState("main")
	ClusterDasFdmAvailabilityStateConnectedToMain            = ClusterDasFdmAvailabilityState("connectedToMain")
	ClusterDasFdmAvailabilityStateNetworkPartitionedFromMain = ClusterDasFdmAvailabilityState("networkPartitionedFromMain")
...
const (
	...
	VsanHostNodeStateMain                  = VsanHostNodeState("main")
